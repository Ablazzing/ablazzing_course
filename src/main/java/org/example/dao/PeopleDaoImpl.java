...
public class PeopleDaoImpl implements PeopleDao {
    ...
    @Autowired
    public PeopleDaoImpl(PeopleEntityMapper peopleEntityMapper, @Value("${people_file}") String path)
    ...
    public List<PeopleEntity> findByName(String name) throws IllegalFileExtensionException, IOException {
        return CsvWorkerUtil.getTextFromCsvFile(true, filePath).stream()
                .map(e -> peopleEntityMapper.convertTextToEntity(e, DELIMITER))
                .filter(e -> e.getName().equals(name))
                .collect(Collectors.toList());
    }
    ...
    @Override
    public void saveListEntities(List<PeopleEntity> peopleEntities) throws IllegalFileExtensionException, IOException {
